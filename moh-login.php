...
if(isset($_POST['login']))
  {
    ...
    $query=mysqli_query($con,"select ID from tblmoh where  FullName='$uname' && password='$password' ");
    $ret=mysqli_fetch_array($query);
    if($ret>0){
      $_SESSION['aid']=$ret['ID'];
     header('location:gs-dashboard.php');
    }
    else{
...
<head>
    ...
    <title>Vaccination Management System | MOH Login</title>
