...
<div class="card-body">
  <?php
  $eid=$_POST['edit_id4'];
  $sql="SELECT tblbooking.BookingID,tblbooking.Name,tblbooking.MobileNumber,tblbooking.Email,tblbooking.EventDate,tblbooking.EventStartingtime,tblbooking.VaccineCenter,tblbooking.VenueAddress,tblbooking.EventType,tblbooking.AdditionalInformation,tblbooking.BookingDate,tblbooking.Remark,tblbooking.Status,tblbooking.UpdationDate,tblservice.ServiceName,tblservice.SerDes,tblservice.ServicePrice from tblbooking join tblservice on tblbooking.ServiceID=tblservice.ID  where tblbooking.ID=:eid";
    ...
    { 
      ...
      <table border="1" class="table align-items-center table-flush table-bordered">
        ...
        <tr>
          ...
          <td><?php  echo $row->VaccineCenter;?></td>
          <th>Venue Address</th>
