...
$query="insert into tblmoh(EmpID,FullName,MobileNumber,Email,NIC,Area,District) values('$empid','$fname','$mnumber','$email','$nic','$area','$district')";
$result =mysqli_query($con, $query);
if ($result) {
echo '<script>alert("MOH created successfully.")</script>';
  echo "<script>window.location.href='add-moh.php'</script>";
} 
else {
...
<head>
    ...
    <title>Vaccination Management System | Add MOH</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Add MOH</h1>
