...
$query="insert into tblgs(EmpID,FullName,MobileNumber,Email,NIC,Area,District,password) values('$empid','$fname','$mnumber','$email','$nic','$area','$district','$password')";
$result =mysqli_query($con, $query);
if ($result) {
echo '<script>alert("GS created successfully.")</script>';
  echo "<script>window.location.href='add-gs.php'</script>";
} 
else {
...
<head>
    ...
    <title>Vaccination Management System | Add GS</title>
