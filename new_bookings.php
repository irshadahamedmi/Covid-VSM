...
if(isset($_POST['submit']))
{
  ...
  $sql="insert into tblbooking(BookingID,ServiceID,Name,MobileNumber,Email,EventDate,EventStartingtime,VaccineCenter,VenueAddress,EventType,AdditionalInformation)values(:bookingid,:bid,:name,:mobnum,:email,:edate,:est,:vcenter,:vaddress,:eventtype,:addinfo)";
                ...
                <div class="modal-dialog modal-xl">
                  <div class="modal-content">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6"> 
                        <div class="form-group">
                          <label class="label" for="email">Vaccine Booking Date</label>
                          <input type="date" class="form-control" name="eventdate" id="eventdate" placeholder="">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="label" for="name">Select Time</label>
					  ...
					  <div class="col-md-12">
                        <div class="form-group">
                          <label class="label" for="subject">Vaccine Centers:</label>
                          <select type="text" class="form-control" name="vcenter" required="true" >
                            <option value="">Choose Vaccine Center</option>
                            <?php 

                            $sql2 = "SELECT * from   tblvcenter ";
                            ...
                            {          
                              ?>  
                              <option value="<?php echo htmlentities($row->VaccineCenter);?>"><?php echo htmlentities($row->VaccineCenter);?></option>
                            <?php } ?>
                          </select>
                        </div>
                      </div>
