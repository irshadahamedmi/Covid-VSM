...
//getting post values dasd
$email=$_POST['email'];
$fname=$_POST['fullname'];
$mnumber=$_POST['mobilenumber'];
$center=$_POST['Vaccine center'];
$query="insert into tblvaccine(Email,fullName,MobileNumber,center,) values('$email','$fname','$mnumber',$center)";
$result =mysqli_query($con, $query);
if ($result) {
echo '<script>alert(" successfully added.")</script>';
  echo "<script>window.location.href='add-bookings.php'</script>";
} 
else {
...
<head>
    ...
    <title>Vaccination Management System | Add Booking</title>
...
<form name="addphlebotomist" method="post">
  <div class="row">
     ...
     <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="Vaccine center" name="Vaccine center" placeholder="Please enter Vaccine center" required="true" >
