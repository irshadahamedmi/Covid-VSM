...
$query="update tblgs set FullName='$fname',MobileNumber='$mnumber',Email='$email',NIC='$nic',Area='$area',District='$district' where id='$pid'";
$result =mysqli_query($con, $query);
if ($result) {
echo '<script>alert("GS record updated successfully.")</script>';
...
<head>
    ...
    <title>Vaccination Management System | Edit GS</title>
...
<?php 
$pid=intval($_GET['pid']);
$query=mysqli_query($con,"select * from tblgs where id='$pid'");
$cnt=1;
