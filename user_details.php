...
if(isset($_POST['submit']))
{
  ...
  $sql="insert into tbluser(BookingID,ServiceID,Name,MobileNumber,Email,EventDate,EventStartingtime,VaccineCenter,VenueAddress,EventType,AdditionalInformation)values(:bookingid,:bid,:name,:mobnum,:email,:edate,:est,:vcenter,:vaddress,:eventtype,:addinfo)";
