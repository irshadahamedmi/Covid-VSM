...
if(isset($_POST['submit2']))
{
  ...
  $final=$_POST['final'];
  $remark=$_POST['remark'];
  $sql= "update tblbooking set Final=:final,Remark=:remark where ID=:bid";
