...
if (strlen($_SESSION['aid']==0)) {
  ...
  $email=$_POST['email'];
     ...
     $query=mysqli_query($con, "update tblmoh set FullName='$fullname', MobileNumber ='$mobno', Email= '$email' where id='$gsid'");
    if ($query) {
...
<head>
    ...
    <title>Vaccination Management System | MOH Profile</title>
...
<?php include_once('includes/sidebar1.php');?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar1.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">MOH Profile</h1>
  ...
  <div class="row">
                ...
                <?php
$gsid=$_SESSION['aid'];
$ret=mysqli_query($con,"select * from tblmoh where id='$gsid'");
$cnt=1;
